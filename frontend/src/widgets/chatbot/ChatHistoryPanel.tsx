...
export function ChatHistoryPanel() {
  ...
  return (
    <section className="space-y-5">
      <div className="page-panel">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600">이전 문서 기반 질의응답 이력을 조회합니다.</p>
          </div>
          <Link
      ...
      <div className="page-panel py-4">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:gap-4">
          <input
            className="control w-full lg:min-w-0 lg:flex-1"
          ...
          <div className="flex w-full gap-3 lg:w-auto lg:shrink-0">
            <input
              className="control min-w-0 flex-1 lg:w-44 lg:flex-none"
              type="date"
              title="시작일"
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(300px,0.4fr)_minmax(0,1fr)] xl:grid-cols-[minmax(320px,440px)_minmax(0,1fr)]">
