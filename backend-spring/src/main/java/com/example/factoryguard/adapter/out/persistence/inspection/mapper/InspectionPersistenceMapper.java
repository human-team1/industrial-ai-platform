...
public class InspectionPersistenceMapper {
    ...
    public InspectionResultJpaEntity toEntity(InspectionResult result) {
        return InspectionResultJpaEntity.builder()
                ...
                .modelProfile(result.getModelProfile())
                .modelName(result.getModelName())
                .anomalyScore(result.getAnomalyScore())
                .imageThreshold(result.getImageThreshold())
                .predictedLabel(result.getPredictedLabel())
                .heatmapPath(result.getHeatmapPath())
                .pixelThreshold(result.getPixelThreshold())
    ...
    public InspectionResult toDomain(InspectionResultJpaEntity e) {
        return InspectionResult.builder()
                ...
                .modelProfile(e.getModelProfile())
                .modelName(e.getModelName())
                .anomalyScore(e.getAnomalyScore())
                .imageThreshold(e.getImageThreshold())
                .predictedLabel(e.getPredictedLabel())
                .heatmapPath(e.getHeatmapPath())
                .pixelThreshold(e.getPixelThreshold())
                .inferenceTime(e.getInferenceTime())
