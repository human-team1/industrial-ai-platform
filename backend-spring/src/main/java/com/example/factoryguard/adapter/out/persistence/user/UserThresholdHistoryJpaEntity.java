...
public class UserThresholdHistoryJpaEntity {
    ...
    @Column(name = "old_anomaly_threshold", nullable = false, columnDefinition = "DECIMAL(8,4)")
    private double oldAnomalyThreshold;

    @Column(name = "new_anomaly_threshold", nullable = false, columnDefinition = "DECIMAL(8,4)")
