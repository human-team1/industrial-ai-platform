...
public enum ErrorCode {
    ...
    INVALID_GOOGLE_TOKEN("AUTH-401", HttpStatus.UNAUTHORIZED, "Invalid Google ID token"),
    INVALID_REFRESH_TOKEN("AUTH-402", HttpStatus.UNAUTHORIZED, "Invalid or expired refresh token");
